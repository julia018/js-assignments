...
function getCardId(value) {    
    const kinds = 'A234567891JQK';
    const suits = '♣♦♥♠';   
    let thisSuit = value[value.length - 1];
    let thisKind = value[0];
    return suits.indexOf(thisSuit)* 13 + kinds.indexOf(thisKind);   
}
